...
impl Weapon {
    pub fn new<S: AsRef<str>>(name: S) -> Self {
        let main_stat_type = *BonusStatType::random_from([BonusStatType::AttackDamageFlat,
            BonusStatType::AttackDamagePercent,
            BonusStatType::AttackSpeed,
            BonusStatType::MagicDamageFlat,
            BonusStatType::MagicDamagePercent].iter()).unwrap();
    ...
    pub fn upgrade(&mut self, xp_source: Vec<Box<dyn Xp>>) {
        ...
        while upgrade_xp != 0 {
            ...
            if used_xp == xp_needed {
                ...
                if sub_stats_len > 0 && self.level % 10 == 0 {
